...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="side-menu">
            ...
            <li><a href="Producto/Editar.php"><i class='bx bxs-minus-circle'></i>Eliminar Productos</a></li>
            <li><a href="Producto/eliminar.php"><i class='bx bxs-edit-alt'></i>Editar Productos</a></li>
