...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        if (isset($_SERVER['HTTP_REFERER'])) {
            ...
            header("Location: ../public/cash/Reportes.php");
            exit();
        }

    } catch (Exception $e) {
        echo '<script>alert("No se pudo enviar el mensaje. Error de envío ' . $mail->ErrorInfo . '"); window.location.href = "../public/cash/Reportes.php";</script>';
    }
}
