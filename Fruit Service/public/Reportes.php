    ...
    <main class="contenido">
        ...
        <form>
            ...
            <div class="form-group">
                <label for="exampleFormControlSelect1">Encargado <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-fill" viewBox="0 0 16 16">
                    <path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6"/>
                  </svg></label>
                <select class="form-control" id="exampleFormControlSelect1">
                  <option>Fabian Kopp</option>
            ...
            <div class="form-group">
              <label for="exampleFormControlTextarea1">Asunto <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-envelope" viewBox="0 0 16 16">
            ...
            <div class="form-group">
                <label for="exampleFormControlFile1">Evidencia de Reporte <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-check-fill" viewBox="0 0 16 16">
                  ...
                  <label class="custom-file-upload">Cargar Evidencia<input type="file" class="form-control-file" id="exampleFormControlFile1"></label>
            </div>
            <button type="submit" class="btn btn-primary mb-2"><svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" fill="currentColor" class="bi bi-capslock-fill" viewBox="0 2 16 16">
             ...
             <br> 
            <p><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-envelope-exclamation-fill" viewBox="0 0 16 16">
