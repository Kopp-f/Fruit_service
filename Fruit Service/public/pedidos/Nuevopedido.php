                                        ...
                                        <table id="tabla" class="table table-striped" style="text-align: center;">
                                            ...
                                            <tbody>
                                                ...
                                                while ($consulta = mysqli_fetch_array($resultado)) {                  
                                                    echo "<tr>";
                                                    echo "<td><img src='../imagenes/" . $consulta["Imagen"] . "' class='table-img'  style='width: 100px;height: auto;'> <br>". $consulta["Nombre_del_producto"]  ."</td>";
                                                    echo "<td>" . $consulta["descripcion"] . "</td>";
                                                    echo "<td>" .  $consulta["Precio"] . "</td>";
                                                    echo '<td>  <input id="quantity" type="number" value="1"
                                                            class="form-control quantity-input">';
                                                    echo '<td> <center><button onclick=" "  class="btn btn-sm btn-primary"
                                ...
                                <div class="summary">
                                    ...
                                    <div class="summary-item"><span class="text">Productos:</span>
                                        ...
                                        <table style="text-align: center;">
                                            ...
                                            <tbody>
                                                <tr> Ensalada especial</tr>
                                                <tr class="price">11000</tr>
                                                <tr><button class="btn btn-danger"
                                                    style="background-color: red;  font-size:13px;margin:3px; text-align: center;color:white "><i class="fa-solid fa-trash-can"></i></button></tr>
                                            </tbody>
                                    ...
                                    <div class="summary-item"><span class="text">Subtotal</span><span
                                            class="price">variable_</span></div>
