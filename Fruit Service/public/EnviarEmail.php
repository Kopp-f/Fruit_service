...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $mail->send();
        echo '<script>alert("Correo Fue Enviado Exitosamente"); window.location.href = "cajas.php";</script>';;
    } catch (Exception $e) {
        echo '<script>alert("No se pudo enviar el mensaje. Error de envío ' . $mail->ErrorInfo . '"); window.location.href = "cajas.php";</script>';
    }
}
?>
