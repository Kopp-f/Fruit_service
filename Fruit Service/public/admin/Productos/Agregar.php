                ...
                <div class="orders">
                    <section>
                        <div class="Usuario">
                            <br>
                            <div>
                                <form id="addProductForm" action="../../../Configuracion/Agrega.php" enctype="multipart/form-data" method="post">
                                    <table id="datatable_users" class="table">
                                        ...
                                        <tbody id="tableBody_users">
                                            <tr>
                                                <td><input type="text" name="Nombre_producto" required style="width: 150px; margin: 5px; margin-right: 7px;"></td>
                                            </tr>
                                        </tbody>
                                        ...
                                        <tbody id="tableBody_users">
                                            <tr>
                                                <td><textarea name="Descripcion" required cols="40" rows="4"></textarea></td>
                                            </tr>
                                        </tbody>
                                        ...
                                        <tbody id="tableBody_users">
                                            <tr>
                                                <td><input name="Precio" type="number" required style="width: 150px; margin: 5px; margin-right: 7px;"></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        ...
                                                        <br>
                                                        <img id="imagePreview" src="#" alt="Previsualización" style="display:none; max-width: 500px; max-height: 500px;">
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
