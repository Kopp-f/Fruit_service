...
{
    $query = "SELECT id_pedido, total, transferencia FROM pedidos_enc";
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        $cantidad_pedidos++;
        if ($row['transferencia'] == 'transferencia') {
        ...
        <main>
            ...
            <ul class="insights">
                ...
                <li><i class='bx bx-line-chart'></i>
                    <span class="info">
                        <h3><?php echo $data['cantidad_transferencias']; ?></h3>
                        <p>pedidos pagados por transferencia</p>
                    </span>
                </li>
