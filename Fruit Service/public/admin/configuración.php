<?php
/**
 * Este archivo es la página principal de configuración del usuario en la aplicación.
 * Se inicia una sesión y se establece la zona horaria para mostrar la fecha actual.
 * 
 * Funciones principales:
 * - Muestra la interfaz de usuario donde el usuario puede cambiar su nombre, 
 *   contraseña e imagen de perfil.
 * - Verifica si hay datos de sesión disponibles para mostrar la imagen y el nombre 
 *   del usuario actual.
 * - Incluye las librerías necesarias como Bootstrap, jQuery y DataTables para mejorar 
 *   la presentación y la funcionalidad.
 * - Maneja formularios para la actualización de datos del usuario, mostrando 
