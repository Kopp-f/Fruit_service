<?php
// Este archivo es parte de un sistema de gestión de pedidos llamado "Fruit Service".
// Se inicia una sesión para manejar la autenticación del usuario y se establece la zona horaria a Bogotá, Colombia.
// La fecha actual se almacena para su uso en la interfaz. 
// El contenido del archivo incluye una interfaz de usuario que permite a los usuarios cambiar su nombre de usuario, 
// contraseña y la imagen de perfil. Utiliza Bootstrap y jQuery para el diseño y funcionalidad. 
// Se muestran notificaciones de errores y mensajes de estado mediante alertas y SweetAlert2.
// La barra lateral y la barra de navegación proporcionan accesos directos a otras partes del sistema. 
// El usuario puede buscar elementos y ver su perfil en la parte superior derecha de la interfaz.
session_start();
