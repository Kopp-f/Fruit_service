<?php
// Este archivo es parte del sistema de gestión de cajas del "Fruit Service". 
// Se inicia una sesión para manejar la autenticación de usuarios y se establece la zona horaria a Bogotá, Colombia.
// La fecha actual y el nombre del usuario se almacenan para su uso en la interfaz.
// El código incluye una funcionalidad para abrir una nueva caja mediante un formulario emergente (SweetAlert) 
// que permite al usuario ingresar un valor de apertura.
// También se presenta una tabla que muestra las cajas registradas y su información (ID, fecha, encargado, base e ingresos).
// El usuario puede buscar, eliminar cajas existentes y cambiar el tema de la interfaz. 
// Se utilizan Bootstrap y jQuery para el diseño y la funcionalidad, y SweetAlert para la gestión de alertas y confirmaciones.
session_start();
