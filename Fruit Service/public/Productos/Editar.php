            ...
            <ul>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="Agregar.php"><ion-icon name="duplicate-outline"></ion-icon>Crear</a></li>
                ...
                <table id='tabla' class='table table-striped'  style="text-align: center;">
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<td><a href='EditarProducto.php?id=" . $row["id_producto"] . "' class='btn btn-sm btn-primary'><i class='fa-solid fa-pencil'></i> Editar</a></td>";
                            echo "</tr>";
                        }
